...
@Entity
@Table(name = "groups_azure")
public class GroupsAzure {
    @Id
    ...
    public GroupsAzure(java.util.UUID groupId, String groupName, String description, Date createdAt, Date updatedAt) {
