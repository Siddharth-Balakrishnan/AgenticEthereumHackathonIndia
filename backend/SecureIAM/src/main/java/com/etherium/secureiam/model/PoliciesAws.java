...
@Entity
@Table(name = "policies_aws")
public class PoliciesAws {
    @Id
    ...
    public PoliciesAws(java.util.UUID policyId, String policyName, String description, String permissions, Date createdAt, Date updatedAt) {
