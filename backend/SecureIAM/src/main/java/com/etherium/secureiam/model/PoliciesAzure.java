...
@Entity
@Table(name = "policies_azure")
public class PoliciesAzure {
    @Id
    ...
    public PoliciesAzure() {
    }

    public PoliciesAzure(java.util.UUID policyId, String policyName, String description, String permissions, Date createdAt, Date updatedAt) {
